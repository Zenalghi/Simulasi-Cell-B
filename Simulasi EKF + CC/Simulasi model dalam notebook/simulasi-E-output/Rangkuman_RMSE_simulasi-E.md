...
Lokasi Folder: `simulasi-E-output/`
...
* **Q Matriks (Process Noise):** 
  ...
  * `Q_11` (Noise Dinamika Tegangan Vc1): 0.0002
* **R Matriks (Measurement Noise):** ADAPTIF! (Charge = 0.04, Discharge/Rest = 0.008)
...
## 2. Tabel Hasil Perhitungan RMSE simulasi-E.ipynb
...
| :--- | :---: | :---: | :---: |
| Pengujian Charging (C-CV) | 4.2479% | 2.3068% | 20.7834 mV |
| Pengujian Discharging (D-CC) | 9.6592% | 6.3366% | 6.1586 mV |
| Pengujian Pembebanan Dinamis (Urban Load) | 4.5892% | 2.8564% | 7.5684 mV |
| Pengujian Mixed (D-CC -> Rest -> C-CV 7.33A) | 0.6107% | 0.9543% | 20.1586 mV |

...
Lokasi Folder: `simulasi-B-output/`
...
* **Q Matriks (Process Noise):** 
  * `Q_00` (Noise Integrasi Arus): 5e-06
  * `Q_11` (Noise Dinamika Tegangan Vc1): 0.0005
* **R Matriks (Measurement Noise):** 0.01 (Noise Sensor Tegangan)
...
## 2. Tabel Hasil Perhitungan RMSE simulasi-B.ipynb

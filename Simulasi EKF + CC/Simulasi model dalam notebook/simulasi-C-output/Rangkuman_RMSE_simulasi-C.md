...
Lokasi Folder: `simulasi-C-output/`
...
* **Q Matriks (Process Noise):** 
  * `Q_00` (Noise Integrasi Arus): 5e-07
  * `Q_11` (Noise Dinamika Tegangan Vc1): 5e-05
* **R Matriks (Measurement Noise):** 0.02 (Noise Sensor Tegangan)
...
## 2. Tabel Hasil Perhitungan RMSE simulasi-C.ipynb
...
| :--- | :---: | :---: | :---: |
| Pengujian Charging (C-CV) | 4.2479% | 8.8390% | 25.2633 mV |
| Pengujian Discharging (D-CC) | 9.6592% | 7.8164% | 8.2845 mV |
| Pengujian Pembebanan Dinamis (Urban Load) | 4.5892% | 3.3079% | 14.6845 mV |
| Pengujian Mixed (D-CC & C-CV 7.33A) | 0.6107% | 4.8346% | 26.5971 mV |

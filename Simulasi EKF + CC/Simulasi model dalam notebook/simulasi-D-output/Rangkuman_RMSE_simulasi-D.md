...
Lokasi Folder: `simulasi-D-output/`
...
* **Q Matriks (Process Noise):** 
  ...
  * `Q_11` (Noise Dinamika Tegangan Vc1): 0.0001
* **R Matriks (Measurement Noise):** 0.005 (Noise Sensor Tegangan)
...
## 2. Tabel Hasil Perhitungan RMSE simulasi-D.ipynb
...
| :--- | :---: | :---: | :---: |
| Pengujian Charging (C-CV) | 4.2479% | 4.0649% | 57.2931 mV |
| Pengujian Discharging (D-CC) | 9.6592% | 7.0683% | 6.1910 mV |
| Pengujian Pembebanan Dinamis (Urban Load) | 4.5892% | 3.1173% | 7.7223 mV |
| Pengujian Mixed (D-CC & C-CV 7.33A) | 0.6107% | 1.8149% | 11.8893 mV |
